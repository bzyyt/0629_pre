...
def main():
    ...
    scratch_model = model_factory(cfg.NUM_CLASSES).to(cfg.device)
    ...
    plot_history.plot_history(scratch_history, "custom_scratch")
    ...
    feature_extractor_model = build_feature_extractor_model(cfg.NUM_CLASSES).to(
        cfg.device
    )
